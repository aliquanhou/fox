...
fn ntcmach_path() -> PathBuf {
    PathBuf::from(r"C:\Users\Administrator\Desktop\制版软件\NTCDLLA2.DLL")
}
...
fn batch_ntcdlla2_dll() {
    ...
    // RM-7: Reconstruct C source from structured IR (all_funcs still borrows built_entries).
    {
        ...
        std::fs::write(r"C:\Users\Administrator\Desktop\ntcdlla2_recovered.c", &src)
            .expect("write recovered.c");
        println!("RM-7 wrote ntcdlla2_recovered.c ({} bytes, {} funcs)", src.len(), cfuncs.len());
    }
